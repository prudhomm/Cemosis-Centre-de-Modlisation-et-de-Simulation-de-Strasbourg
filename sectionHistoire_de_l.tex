...
Nous rédigeons à ce moment un plan stratégique de développement à 4 ans avec une transition pour Cemosis de devenir une plateforme de l'Université. Si Cemosis n'a pas le chiffre d'affaire de plateforme telles que le Sertit, Service Régional de Traitement d'Image et de Télédétection, il est considéré comme ayant un fort potentiel par l'Université et est affichée en tant que telle sur le \href{http://entreprises.unistra.fr/innover/decouvrir-les-plateformes-technologiques-de-luniversite/#c3136}{portail entreprise de l'Université} en .
